...
export class Ventas implements OnInit {
  ...
  confirmarPagoQR() {
    ...
    this.http.post<any>('http://34.230.18.9:8000/api/v1/ventas/generar-qr', payload).subscribe({
      next: (res) => {
  ...
  checkQRPaymentStatus() {
    ...
    this.http.get<any>(`http://34.230.18.9:8000/api/v1/ventas/estado-pago-qr/${this.qrTxId}`).subscribe({
      next: (res) => {
  ...
  simularEscaneoCliente() {
    ...
    this.cdr.detectChanges();
    this.http.post<any>(`http://34.230.18.9:8000/api/v1/ventas/simular-pago-cliente/${this.qrTxId}`, {}).subscribe();
  ...
  confirmarPagoStripe() {
    ...
    this.http.post<any>('http://34.230.18.9:8000/api/v1/ventas/create-payment-intent', payload).subscribe({
      next: (res) => {
